  ...
  return (
    <>
      <div className="min-h-screen dark:text-white pt-20 ">
        <h1 className="text-center text-3xl">All Brands</h1>
...
h78.747C231.693,100.736,232.77,106.162,232.77,111.694z" />
          ...
          <>
            <div className="container mx-auto grid lg:grid-cols-6 md:grid-cols-4 sm:grid-cols-2 py-5 gap-5 shadow-lg">
              {searchResult?.map((brand) => (
                <div key={brand.id} className="shadow-lg ">
                  <img
